...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'ashishstack@gmail.com',
    phone: '+91-8328878422',
    address: {
      line1: "LIG-72 K-4",
      line2: "Kalinga Nagar, Bhubaneswar"
    },
    gender: 'Male',
    dob: '1990-03-10'
  })
  ...
  return (
    <div>
      ...
      {
        isEdit
          ? <input onChange={(e) => setUserData(prev => ({ ...prev, name: e.target.value }))} value={userData.name} type="text" required />
          : <p>{userData.name}</p>
      }
      ...
      <div>
        ...
        <div >
          ...
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
            ...
            {
              isEdit
                ? <select className='max-w020 bg-gray-100 ' onChange={(e) => setUserData(prev => ({ ...prev, gender: e.target.value }))} value={userData.gender}>
